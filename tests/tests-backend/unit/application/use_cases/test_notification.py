...
async def test_create_notification():
    ...
    result = await use_cases.create_notification(user_id=user_id, notification_in=notif_in)
...
async def test_get_all_notifications():
    ...
    expected_list = [Notification(id=uuid4(), title="Not1", message="Teste", user_id=user_id)]
...
async def test_mark_as_read_success():
    ...
    existing_notif = Notification(id=notif_id, title="Not1", message="Teste", user_id=user_id, is_read=False)
