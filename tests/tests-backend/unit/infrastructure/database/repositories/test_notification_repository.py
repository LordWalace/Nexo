...
async def test_create_notification():
    ...
    notification = Notification(id=uuid4(), title="Alerta", message="Teste", user_id=uuid4())
...
async def test_get_by_id_notification():
    ...
    notification = Notification(id=notif_id, title="Alerta", message="Teste", user_id=user_id)
...
async def test_update_notification():
    ...
    notification = Notification(id=uuid4(), title="Alerta Update", message="Teste Update", user_id=uuid4())
