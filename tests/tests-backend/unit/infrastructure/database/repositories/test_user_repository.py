...
async def test_create_user():
    ...
    user = User(id=uuid4(), name="Test User", email="test@test.com", password_hash="hash")
...
async def test_get_by_id_user():
    ...
    user = User(id=user_id, name="Test User", email="test@test.com", password_hash="hash")
...
async def test_restore_user():
    ...
    user = User(id=uuid4(), name="Test", email="test@test.com", password_hash="hash", deleted_at=datetime.now(UTC))
