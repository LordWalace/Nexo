...
async def test_create_history():
    ...
    period = ActivityExecutionPeriod(id=uuid4(), start_time=datetime.now(UTC), user_id=uuid4(), activity_id=uuid4())
...
async def test_get_by_id_history():
    ...
    period = ActivityExecutionPeriod(id=period_id, start_time=datetime.now(UTC), user_id=user_id, activity_id=uuid4())
...
async def test_get_all_by_user_history():
    ...
    period_list = [
        ActivityExecutionPeriod(id=uuid4(), start_time=datetime.now(UTC), user_id=user_id, activity_id=uuid4()),
        ActivityExecutionPeriod(id=uuid4(), start_time=datetime.now(UTC), user_id=user_id, activity_id=uuid4())
    ]
