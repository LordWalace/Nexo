...
async def test_get_current_user_valid():
    ...
    with patch("app.core.dependencies.decode_access_token", return_value=str(user_id)) as mock_decode, \
...
async def test_get_current_user_not_found():
    ...
    with patch("app.core.dependencies.decode_access_token", return_value=str(user_id)), \
         patch("app.core.dependencies.UserRepository") as mock_repo_class:
